/**
 * Seed script for country calling codes.
 * Run: node scripts/seed-country-codes.js
 */
const mongoose = require('mongoose');
require('dotenv').config();

const CountryCode = require('../src/models/CountryCode');
...
const countryCodes = [
  ...
  { name: 'Bahrain', code: 'BH', dialCode: '+973', flag: '🇧🇭', priority: 8 },
  ...
  { name: 'Egypt', code: 'EG', dialCode: '+20', flag: '🇪🇬', priority: 7 },
  ...
  { name: 'India', code: 'IN', dialCode: '+91', flag: '🇮🇳', priority: 6 },
  { name: 'Indonesia', code: 'ID', dialCode: '+62', flag: '🇮🇩' },
  { name: 'Iran', code: 'IR', dialCode: '+98', flag: '🇮🇷' },
  { name: 'Iraq', code: 'IQ', dialCode: '+964', flag: '🇮🇶', priority: 5 },
  ...
  { name: 'Jordan', code: 'JO', dialCode: '+962', flag: '🇯🇴', priority: 7 },
  { name: 'Kazakhstan', code: 'KZ', dialCode: '+7', flag: '🇰🇿' },
  { name: 'Kenya', code: 'KE', dialCode: '+254', flag: '🇰🇪' },
  { name: 'Kuwait', code: 'KW', dialCode: '+965', flag: '🇰🇼', priority: 8 },
  { name: 'Kyrgyzstan', code: 'KG', dialCode: '+996', flag: '🇰🇬' },
  { name: 'Laos', code: 'LA', dialCode: '+856', flag: '🇱🇦' },
  { name: 'Latvia', code: 'LV', dialCode: '+371', flag: '🇱🇻' },
  { name: 'Lebanon', code: 'LB', dialCode: '+961', flag: '🇱🇧', priority: 6 },
  ...
  { name: 'Oman', code: 'OM', dialCode: '+968', flag: '🇴🇲', priority: 8 },
  { name: 'Pakistan', code: 'PK', dialCode: '+92', flag: '🇵🇰' },
  { name: 'Palestine', code: 'PS', dialCode: '+970', flag: '🇵🇸', priority: 6 },
  ...
  { name: 'Qatar', code: 'QA', dialCode: '+974', flag: '🇶🇦', priority: 8 },
  { name: 'Romania', code: 'RO', dialCode: '+40', flag: '🇷🇴' },
  { name: 'Russia', code: 'RU', dialCode: '+7', flag: '🇷🇺' },
  { name: 'Rwanda', code: 'RW', dialCode: '+250', flag: '🇷🇼' },
  { name: 'Saudi Arabia', code: 'SA', dialCode: '+966', flag: '🇸🇦', priority: 10 },
  ...
  { name: 'United Arab Emirates', code: 'AE', dialCode: '+971', flag: '🇦🇪', priority: 9 },
...
async function seedCountryCodes() {
  try {
    const mongoURI = process.env.MONGODB_URI || process.env.MONGO_URI || 'mongodb://localhost:27017/url-shortener';
    ...
    console.log('Cleared existing country codes');

    // Insert all country codes
    const result = await CountryCode.insertMany(countryCodes);
    console.log(`Inserted ${result.length} country codes`);

    // Show top priority ones
    const topCodes = await CountryCode.find({ isActive: true })
      .sort({ priority: -1, name: 1 })
      .limit(10);
    console.log('\nTop priority country codes:');
    topCodes.forEach(c => console.log(`  ${c.flag} ${c.name} (${c.dialCode}) - priority: ${c.priority}`));
