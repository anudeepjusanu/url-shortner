...
class GeoLocationService {
  ...
  getLocationStats(locations) {
    ...
    locations.forEach((location) => {
      if (location.country) {
        stats.countries[location.country] =
          (stats.countries[location.country] || 0) + 1;
      }

      if (location.region) {
        stats.regions[location.region] =
          (stats.regions[location.region] || 0) + 1;
      }
      ...
      if (location.timezone) {
        stats.timezones[location.timezone] =
          (stats.timezones[location.timezone] || 0) + 1;
      }
    });
...
module.exports = {
  getLocationFromIP:
    geoLocationService.getLocationFromIP.bind(geoLocationService),
  ...
  calculateDistance:
    geoLocationService.calculateDistance.bind(geoLocationService),
  getTimezoneFromLocation:
    geoLocationService.getTimezoneFromLocation.bind(geoLocationService),
  getCurrentTimeInLocation:
    geoLocationService.getCurrentTimeInLocation.bind(geoLocationService),
  validateLocationRestrictions:
    geoLocationService.validateLocationRestrictions.bind(geoLocationService),
  getBulkLocations:
    geoLocationService.getBulkLocations.bind(geoLocationService),
  getLocationStats:
    geoLocationService.getLocationStats.bind(geoLocationService),
