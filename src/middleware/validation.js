...
const validateRegistration = [
  ...
  body("phone")
    ...
    .withMessage(
      "Please enter a valid phone number (e.g., +9665XXXXXXXX, 05XXXXXXXX, +919XXXXXXXXX, or 9XXXXXXXXX)",
    ),
  body("password")
    .isLength({ min: 8 })
...
const validatePagination = [
  ...
  query("sortBy")
    ...
    .withMessage(
      "Sort by must be one of: createdAt, updatedAt, clickCount, title",
    ),
  query("sortOrder")
    .optional()
    .isIn(["asc", "desc"])
...
const validateDomain = [
  ...
  body("subdomain")
    ...
    .withMessage(
      "Invalid subdomain format - supports international subdomains",
    ),
  body("isDefault")
    .optional()
    .isBoolean()
