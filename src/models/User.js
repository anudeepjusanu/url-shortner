...
const userSchema = new mongoose.Schema(
  {
    ...
    // Bumped on logout, password change, and deactivation so previously-issued
    // JWTs (which are otherwise stateless and valid until they expire) stop
    // being accepted immediately instead of remaining usable for up to
...
userSchema.methods.hasPermission = function (resource, action) {
  ...
  if (
    ...
    this.permissions[resource][action] !== undefined
  ) {
