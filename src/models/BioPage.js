...
const BioPageSchema = new mongoose.Schema(
  {
    ...
    // System domain this page was created under (e.g. qa.snip.sa vs
    // qa.4r.sa) — pinned at creation so the public URL doesn't drift if a
    // second main domain is introduced later. Null for legacy pages created
