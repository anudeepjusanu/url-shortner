  ...
  const clauses = [
    {
      ...
      content: t(
        `${brand.name} respects your privacy and is committed to providing excellent service to all our customers. This Privacy Notice has been drafted in accordance with the Personal Data Protection Law and its regulations in the Kingdom of Saudi Arabia to help you understand the nature of the data we collect from you and how this data will be handled by ${brand.name}. Out of ${brand.name}'s commitment to the privacy and confidentiality of user data, we are dedicated to maintaining the security and confidentiality of this information and using it to deliver the expected level of service in compliance with the applicable terms and conditions in the Kingdom of Saudi Arabia. By using the ${brand.name} website, the user consents to this Privacy Policy.`,
    ...
    {
      title: t(
        "Clause 2: Data to Be Collected and Purpose of Collection",
        "البند 2: البيانات التي سيتم جمعها والغرض من جمعها",
      ),
      items: [
        t(
    ...
    {
      title: t(
        "Clause 3: Purpose of Collecting Personal Data",
        "البند 3: الغرض من جمع البيانات الشخصية",
      ),
      intro: t(
      ...
      items: [
        t(
          "Enabling us to develop, improve, and/or market products and services.",
          "تمكيننا من تطوير المنتجات والخدمات وتحسينها و/أو تسويقها.",
        ),
        t(
          "Facilitating and supporting our operations and systems to ensure continuity and quality of our services.",
          "تيسير عملياتنا وأنظمتنا ودعمها لضمان استمرارية جودة خدماتنا.",
        ),
        t(
          "Understanding customer needs, assessing your eligibility for products and services, and recommending relevant products and services.",
          "فهم احتياجات العملاء وتقييم أهليتك للمنتجات والخدمات وتوصية المنتجات والخدمات ذات الصلة.",
        ),
        t(
          "Notifying you about new products and services.",
          "إخطارك بالمنتجات والخدمات الجديدة.",
        ),
        t(
          "Responding to and following up on inquiries, suggestions, or complaints submitted by the user.",
          "الرد على الاستفسارات والاقتراحات أو الشكاوى المقدمة من المستخدم ومتابعتها.",
        ),
      ],
    },
    {
      title: t(
        ...
        "البند 4: طرق جمع البيانات",
      ),
      items: [
        t(
          "Data provided directly by the user through registration on the website.",
          "البيانات التي يقدمها المستخدم مباشرةً من خلال التسجيل في الموقع الإلكتروني.",
        ),
        t(
          "Data collected through cookies during website visits.",
          "البيانات التي يتم جمعها من خلال ملفات تعريف الارتباط أثناء زيارات الموقع الإلكتروني.",
        ),
      ],
    },
    {
      title: t(
        "Clause 5: Storage and Destruction of Personal Data",
        "البند 5: تخزين البيانات الشخصية وإتلافها",
      ),
      content: t(
        `Personal data is stored within the Kingdom of Saudi Arabia on servers protected by advanced technologies in compliance with the policies and controls of the National Cybersecurity Authority and international standards to prevent unauthorized access and mitigate cybersecurity risks. When the data is no longer needed and as per the regulations, it will be destroyed securely to ensure it cannot be accessed or recovered, in accordance with ${brand.name}'s policies.`,
    ...
    {
      title: t(
        "Clause 6: Legal Basis for Collecting and Processing Personal Data",
        "البند 6: الأساس القانوني لجمع البيانات الشخصية ومعالجتها",
      ),
      content: t(
        `Personal data is collected and processed based on the consent of the data subject. The data subject may withdraw their consent to collect and process their data at any time, unless there is another legal basis. To do so, please contact ${brand.name}'s support team via:`,
    ...
    {
      title: t(
        "Clause 7: Rights of the Data Subject",
        "البند 7: حقوق صاحب البيانات",
      ),
      rights: [
        {
        ...
        },
        {
          heading: t(
            ...
            "حق سحب الموافقة على معالجة البيانات الشخصية:",
          ),
          body: t(
    ...
    {
      title: t(
        "Clause 8: Sharing/Exchanging Personal Data",
        "البند 8: مشاركة/تبادل البيانات الشخصية",
      ),
      content: t(
    ...
    {
      title: t(
        "Clause 9: Exercising the Rights of the Data Subject",
        "البند 9: ممارسة حقوق صاحب البيانات",
      ),
      content: t(
    ...
    {
      title: t(
        "Clause 10: Complaints and Inquiries",
        "البند 10: الشكاوى والاستفسارات",
      ),
      content: t(
    ...
    {
      title: t(
        "Clause 11: Updates to the Privacy Policy",
        "البند 11: تحديثات سياسة الخصوصية",
      ),
      content: t(
        `The Privacy Policy was last updated on January 13, 2025. ${brand.name} reserves the right to add or modify any terms of the Privacy Policy. The website management will notify the data subject of any changes, and the data subject's account may be terminated if they do not accept the updated Privacy Policy after being notified.`,
