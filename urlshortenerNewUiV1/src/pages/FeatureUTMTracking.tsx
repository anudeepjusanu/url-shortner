...
const FeatureUTMTracking = () => {
  ...
  const params = [
    {
      ...
      desc: t("Where the traffic comes from", "من وين يجي الترافيك"),
      color: "hsl(var(--sky))",
    },
    {
      key: "utm_medium",
      value: "story_link",
      label: t("Medium", "الوسيط"),
      desc: t("The marketing medium", "الوسيط التسويقي"),
      color: "hsl(var(--navy))",
    },
    {
      key: "utm_campaign",
      ...
      desc: t("Your campaign name", "اسم حملتك"),
      color: "hsl(280 60% 55%)",
    },
    {
      key: "utm_content",
      ...
      desc: t("Differentiate similar content", "ميّز المحتوى المتشابه"),
      color: "hsl(150 60% 45%)",
    },
  ];
  ...
  const benefits = [
    {
      ...
      desc: t(
        "See exactly which campaigns bring clicks. Stop guessing, start knowing.",
        "شف بالضبط أي الحملات تجيب ضغطات. وقف عن التخمين وابدأ تعرف.",
      ),
    },
    {
      icon: Layers,
      ...
      desc: t(
        "No need to manually type UTM parameters. Our builder does it for you.",
        "ما تحتاج تكتب معلمات UTM يدوياً. المنشئ يسويها لك.",
      ),
    },
    {
      icon: BarChart3,
      ...
      desc: t(
        "Group clicks by source, medium, or campaign. Beautiful reports without spreadsheets.",
        "جمّع الضغطات حسب المصدر أو الوسيط أو الحملة. تقارير جميلة بدون جداول بيانات.",
      ),
    },
    {
      icon: TrendingUp,
      ...
      desc: t(
        "Run multiple campaigns and see which one performs best, side by side.",
        "شغّل حملات متعددة وشف أيها أفضل، جنب بعض.",
      ),
    },
  ];
  ...
  const scenarios = [
    {
      icon: Mail,
      title: t("Email campaigns", "حملات الإيميل"),
      desc: t(
        "Tag newsletter links to see which emails drive engagement.",
        "وسّم روابط النشرة عشان تشوف أي إيميلات تجيب تفاعل.",
      ),
      color: "hsl(var(--sky))",
    },
    {
      icon: Megaphone,
      title: t("Social media ads", "إعلانات السوشال"),
      desc: t(
        "Compare Instagram vs Twitter vs Snapchat ad performance.",
        "قارن أداء إعلانات إنستقرام وتويتر وسناب شات.",
      ),
      color: "hsl(280 60% 55%)",
    },
    {
      icon: Users,
      title: t("Influencer deals", "صفقات المؤثرين"),
      desc: t(
        "Give each influencer a tagged link. See who brings real clicks.",
        "أعطِ كل مؤثر رابط موسوم. شف مين يجيب ضغطات حقيقية.",
      ),
      color: "hsl(150 60% 45%)",
    },
  ];

  const generatedUrl = `${brand.domain}/ramadan?utm_source=instagram&utm_medium=story_link&utm_campaign=ramadan_2026&utm_content=cta_button`;
              ...
              <div className="bg-white rounded-2xl border border-[hsl(var(--navy))]/8 shadow-elevated overflow-hidden">
                ...
                <div className="p-5 space-y-4">
                  ...
                  {params.map((p, i) => (
                    ...
                    >
                      <div
                        className="w-1.5 h-full min-h-[48px] rounded-full shrink-0 mt-1"
                        style={{ backgroundColor: p.color }}
                      />
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-1">
                          <span className="text-[10px] font-mono font-bold text-[hsl(var(--navy))]/40">
                            {p.key}
                          </span>
                          <span className="text-[10px] font-body text-[hsl(var(--navy))]/30">
                            {p.desc}
                          </span>
                        </div>
                        <div className="bg-[hsl(var(--navy))]/[0.03] rounded-lg px-3 py-2 border border-[hsl(var(--navy))]/6">
                          <span className="text-sm font-body text-[hsl(var(--navy))]">
                            {p.value}
                          </span>
                        </div>
                      </div>
        ...
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <p className="font-body text-lg text-[hsl(var(--navy))]/50 max-w-lg mx-auto">
              {t(
                "Four simple tags that tell you everything about where your clicks come from.",
                "أربع علامات بسيطة تخبرك كل شيء عن مصدر ضغطاتك.",
              )}
            </p>
          </motion.div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 max-w-4xl mx-auto">
            {params.map((p, i) => (
              ...
              >
                ...
                />
                <span
                  className="font-mono text-xs font-bold block mb-2 mt-1"
                  style={{ color: p.color }}
                >
                  {p.key}
                </span>
                <h3 className="font-display font-bold text-[hsl(var(--navy))] mb-1">
                  {p.label}
                </h3>
                <p className="font-body text-xs text-[hsl(var(--navy))]/45 mb-3">
                  {p.desc}
                </p>
                <div className="bg-[hsl(var(--navy))]/[0.03] rounded-lg px-3 py-1.5">
                  <span className="text-xs font-mono text-[hsl(var(--navy))]/60">
                    {p.value}
                  </span>
                </div>
              </motion.div>
            ...
            >
              ...
              <h2 className="font-display text-3xl md:text-4xl font-bold tracking-tight text-[hsl(var(--navy))] mb-4 leading-[1.15]">
                {t(
                  ...
                  "اعرف بالضبط من وين ضغطاتك جايّة",
                )}
              </h2>
              ...
              <div className="space-y-4">
                {benefits.map((b, i) => (
                  ...
                  >
                    ...
                    <div>
                      <h3 className="font-display font-bold text-[hsl(var(--navy))] text-sm mb-0.5">
                        {b.title}
                      </h3>
                      <p className="font-body text-xs text-[hsl(var(--navy))]/45 leading-relaxed">
                        {b.desc}
                      </p>
                    </div>
                  </motion.div>
            ...
            >
              <div className="bg-white rounded-2xl border border-[hsl(var(--navy))]/8 shadow-elevated overflow-hidden">
                <div className="px-5 py-3.5 border-b border-[hsl(var(--navy))]/6 flex items-center justify-between">
                  <span className="text-sm font-display font-bold text-[hsl(var(--navy))]">
                    {t("Campaign Report", "تقرير الحملة")}
                  </span>
                  <span className="text-[10px] font-body text-[hsl(var(--navy))]/35">
                  ...
                  {[
                    ...
                    <div key={i} className="flex items-center gap-3">
                      <div className="w-20 shrink-0">
                        <span className="text-xs font-body font-semibold text-[hsl(var(--navy))]">
                          {row.source}
                        </span>
                        <span className="text-[10px] font-body text-[hsl(var(--navy))]/30 block">
                          {row.medium}
                        </span>
                      </div>
                      ...
                      <span className="text-xs font-display font-bold text-[hsl(var(--navy))] w-12 text-end">
                        {row.clicks}
                      </span>
                    </div>
                  ))}
      ...
      <section className="section-cream-rose py-20 md:py-28">
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <p className="font-body text-lg text-[hsl(var(--navy))]/50 max-w-lg mx-auto">
              {t(
                "Tag every channel and compare results instantly.",
                "وسّم كل قناة وقارن النتائج فوراً.",
              )}
            </p>
          </motion.div>
            ...
            {scenarios.map((s, i) => (
              ...
              >
                ...
                <div className="bg-white border border-[hsl(var(--navy))]/6 rounded-2xl p-7 h-full flex flex-col hover:shadow-elevated hover:-translate-y-1 transition-all duration-300">
                  ...
                  <h3 className="font-display font-bold text-lg text-[hsl(var(--navy))] mb-2">
                    {s.title}
                  </h3>
                  <p className="font-body text-sm text-[hsl(var(--navy))]/50 leading-relaxed flex-1">
                    {s.desc}
                  </p>
                  ...
                  <div className="mt-5 pt-4 border-t border-[hsl(var(--navy))]/5">
                    <div className="flex items-center justify-between mb-1.5">
                      <span className="text-[10px] font-body font-semibold text-[hsl(var(--navy))]/40">
                        {t("Click-through rate", "معدل النقر")}
                      </span>
                      <span
