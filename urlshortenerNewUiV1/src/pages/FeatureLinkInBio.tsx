    ...
    case "youtube":
      return (
        <svg className={cls} viewBox="0 0 24 24" fill="currentColor">
          <path d="M23.5 6.2a3 3 0 00-2.1-2.1C19.5 3.5 12 3.5 12 3.5s-7.5 0-9.4.6A3 3 0 00.5 6.2 31.9 31.9 0 000 12a31.9 31.9 0 00.5 5.8 3 3 0 002.1 2.1c1.9.6 9.4.6 9.4.6s7.5 0 9.4-.6a3 3 0 002.1-2.1c.3-1.8.5-3.8.5-5.8s-.2-4-.5-5.8zM9.5 15.6V8.4l6.3 3.6-6.3 3.6z" />
        </svg>
      );
    case "dribbble":
      return (
        ...
        >
          ...
          <path d="M8.56 2.75c4.37 6 6 12.56 6.44 21.25" />
        </svg>
      );
    case "tiktok":
      return (
        <svg className={cls} viewBox="0 0 24 24" fill="currentColor">
          <path d="M16.6 5.82A4.28 4.28 0 0113.8 3h-3v12.4a2.59 2.59 0 01-2.6 2.6 2.59 2.59 0 01-2.6-2.6 2.59 2.59 0 012.6-2.6c.28 0 .55.05.8.13V9.73A5.8 5.8 0 002.2 15.4a5.8 5.8 0 005.8 5.8 5.8 5.8 0 005.8-5.8V9.57a7.46 7.46 0 004.4 1.43V7.8a4.28 4.28 0 01-1.6-1.98z" />
        </svg>
      );
    case "snapchat":
      return (
        <svg className={cls} viewBox="0 0 24 24" fill="currentColor">
          <path d="M12 2c-3 0-5.2 2-5.5 5.2-.1.8-.1 1.7-.3 2.5-.1.4-.5.8-.9 1-.3.1-.6.2-.8.3-.3.2-.3.5 0 .8.5.3 1 .5 1.4.8.3.2.5.5.5.9 0 .5-.3 1-.7 1.3-.6.5-1.3.8-2 1-.5.2-.6.4-.4.9.2.4.5.6.9.7.6.1 1.2.2 1.6.5.4.3.6.7.7 1.2 0 .1 0 .2.1.3.5-.1 1-.3 1.6-.3.7 0 1.2.2 1.8.5 1 .5 1.8 1.2 3 1.3 1.2-.1 2-.8 3-1.3.6-.3 1.1-.5 1.8-.5.6 0 1.1.2 1.6.3.1-.1.1-.2.1-.3.1-.5.3-.9.7-1.2.4-.3 1-.4 1.6-.5.4-.1.7-.3.9-.7.2-.5.1-.7-.4-.9-.7-.2-1.4-.5-2-1-.4-.3-.7-.8-.7-1.3 0-.4.2-.7.5-.9.4-.3.9-.5 1.4-.8.3-.3.3-.6 0-.8-.2-.1-.5-.2-.8-.3-.4-.2-.8-.6-.9-1-.2-.8-.2-1.7-.3-2.5C17.2 4 15 2 12 2z" />
        </svg>
      );
    case "whatsapp":
      return (
        <svg className={cls} viewBox="0 0 24 24" fill="currentColor">
          <path d="M17.47 14.38c-.3-.15-1.76-.87-2.03-.97-.27-.1-.47-.15-.67.15s-.77.97-.94 1.17c-.17.2-.35.22-.65.07-.3-.15-1.26-.46-2.4-1.48-.89-.79-1.49-1.77-1.66-2.07-.17-.3-.02-.46.13-.61.14-.14.3-.35.45-.53.15-.17.2-.3.3-.5.1-.2.05-.37-.02-.53-.08-.15-.67-1.61-.92-2.2-.24-.58-.49-.5-.67-.51h-.57c-.2 0-.53.07-.8.37s-1.04 1.02-1.04 2.49 1.07 2.89 1.22 3.09c.15.2 2.1 3.2 5.08 4.49.71.31 1.27.49 1.7.63.71.23 1.36.2 1.87.12.57-.09 1.76-.72 2.01-1.42.25-.69.25-1.29.17-1.42-.07-.13-.27-.2-.57-.35zM12.05 21.8a9.77 9.77 0 01-4.98-1.37l-.36-.21-3.73.98.99-3.63-.23-.37a9.77 9.77 0 01-1.5-5.2c0-5.4 4.4-9.8 9.81-9.8a9.74 9.74 0 016.94 2.87 9.74 9.74 0 012.87 6.93c0 5.4-4.4 9.8-9.81 9.8zM20.52 3.48A11.77 11.77 0 0012.05 0C5.46 0 .11 5.34.11 11.93a11.9 11.9 0 001.59 5.95L0 24l6.3-1.65a11.87 11.87 0 005.75 1.47c6.59 0 11.94-5.34 11.94-11.93a11.87 11.87 0 00-3.47-8.41z" />
        </svg>
      );
    case "map-pin":
      return (
...
const FeaturePhoneMockup = ({
  ...
  lang: string;
  brand: { name: string; domain: string; title: string; description: string };
}) => {
  const isAr = lang === "ar";
      ...
      case 0:
        return (
          <div
            ...
            style={{
              background:
                "linear-gradient(160deg, #1A0B2E 0%, #2D1B4E 35%, #C44CFF 70%, #FFB86C 100%)",
            }}
          >
            <StatusBar />
            <div className="px-5 pt-3 flex flex-col items-center text-white">
              <div className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full bg-white/20 backdrop-blur-sm border border-white/30 text-[9px] font-bold mb-3">
                ...
                {t("THEME · MIDNIGHT GLOW", "ثيم · توهج الليل")}
              </div>
              ...
              <p className="text-[10px] text-white/75 mb-3">
                {t("Visual Artist · Jeddah", "فنانة بصرية · جدة")}
              </p>
              <div className="w-full space-y-2">
                {[
                  {
                    label: t("Latest Drop · Posters", "أحدث الأعمال · بوسترات"),
                    bg: "linear-gradient(90deg, #FFB86C, #FF6B9D)",
                  },
                  {
                    label: t("Shop Prints", "متجر اللوحات"),
                    bg: "linear-gradient(90deg, #C44CFF, #6B4CFF)",
                  },
                  {
                    label: t("Behind the scenes", "خلف الكواليس"),
                    bg: "rgba(255,255,255,0.14)",
                  },
                ].map((b, i) => (
                  <div
                    key={i}
                    className="w-full py-2.5 px-3 rounded-2xl text-[11px] font-bold text-white text-center backdrop-blur-sm border border-white/20"
              ...
              <div className="flex gap-2 mt-3">
                {[Instagram, Music2, Youtube].map((Icon, i) => (
                  <div
                    key={i}
                    className="w-7 h-7 rounded-full bg-white/20 border border-white/30 flex items-center justify-center backdrop-blur-sm"
                  >
      ...
      case 1:
        return (
          <div
            ...
            style={{
              background:
                "linear-gradient(160deg, hsl(35 50% 96%) 0%, hsl(35 40% 90%) 100%)",
          ...
          >
            ...
            <div className="px-5 pt-3 flex flex-col items-center text-[#7a253a]">
              <div
                className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full bg-[#7a253a]/10 border border-[#7a253a]/20 text-[9px] font-bold mb-3"
                style={{ direction: "rtl" }}
              >
              ...
              <p className="text-[10px] text-[#7a253a]/70 mb-3">
                كاتبة محتوى · الرياض
              </p>
              <div className="w-full space-y-2">
                {[
                  ...
                  <div
                    key={i}
                    className="w-full py-2.5 px-3 rounded-xl flex items-center gap-2 bg-white border border-[#7a253a]/10 shadow-sm"
                  ...
                  >
                    ...
                    <span className="text-[11px] font-bold text-[#7a253a] flex-1 text-right">
                      {b.label}
                    </span>
        ...
        return (
          ...
          >
            ...
            <div className="px-5 pt-3 flex flex-col items-center text-[#064E3B]">
              ...
              <div className="flex items-center gap-1 mb-0.5">
                <h3 className="text-[13px] font-bold">
                  {t("Brew House", "بيت القهوة")}
                </h3>
                <BadgeCheck className="w-3 h-3" fill="#25D366" stroke="white" />
              </div>
              <p className="text-[10px] text-[#064E3B]/70 mb-3">
                {t("Specialty Coffee · Olaya", "قهوة مختصة · العليا")}
              </p>

              {/* Prominent WhatsApp button */}
              <a
                className="w-full py-3 px-4 rounded-2xl flex items-center justify-center gap-2 mb-2 shadow-lg"
                style={{
                  background:
              ...
              <div className="text-[8px] text-[#064E3B]/50 mb-3">
                {t("Usually replies in minutes", "نرد عادة خلال دقائق")}
              </div>
              ...
              <div className="w-full space-y-1.5">
                {[
                  ...
                  {
                    label: t("Reserve a Table", "احجز طاولة"),
                    icon: CalendarCheck,
                  },
                ].map((b, i) => (
                  <div
                    key={i}
                    className="w-full py-2 px-3 rounded-xl flex items-center gap-2 bg-white border border-[#064E3B]/10 shadow-sm"
                  >
      ...
      case 3:
        return (
          <div
            ...
            style={{
              background:
                "linear-gradient(170deg, hsl(220 45% 18%) 0%, hsl(215 45% 28%) 60%, hsl(210 55% 42%) 100%)",
            }}
          >
            <StatusBar />
            ...
            <div className="px-5 flex flex-col items-center text-white">
              ...
              <div className="flex items-center gap-1 mb-0.5">
                <h3 className="text-[13px] font-bold">
                  {t("Nuqta Studio", "ستوديو نقطة")}
                </h3>
                <BadgeCheck
                  className="w-3 h-3"
                  fill="white"
                  stroke="hsl(215 45% 28%)"
                />
              </div>
              <p className="text-[10px] text-white/70 mb-3">
                {t("Branding & Web Design", "هوية ومواقع")}
              </p>
              <div className="w-full space-y-1.5">
                {[
                  { label: t("Our Work", "أعمالنا"), icon: Briefcase },
                  {
                    label: t("Get a Quote", "اطلب عرض سعر"),
                    icon: MessageCircle,
                  },
                  ...
                  <div
                    key={i}
                    className="w-full py-2 px-3 rounded-xl flex items-center gap-2 bg-white/12 border border-white/20 backdrop-blur-sm"
                  >
              ...
              <div className="mt-3 inline-flex items-center gap-1 text-[8px] font-mono text-white/60">
                ...
                {t(
                  `Your domain · Powered by ${brand.domain}`,
                  `دومينك · بدعم من ${brand.domain}`,
                )}
              </div>
            </div>
          </div>
...
const ThemeShowcaseSection = ({
  ...
  const featureItems = [
    {
      title: t("Beautiful Themes", "ثيمات جميلة"),
      desc: t(
        "Choose from curated themes or fully customize colors, fonts, and backgrounds to match your brand.",
        "اختر من ثيمات مختارة أو خصص الألوان والخطوط والخلفيات لتناسب علامتك التجارية.",
      ),
      color: "hsl(var(--navy))",
    },
    {
      title: t("Full Arabic & RTL", "دعم كامل للعربية"),
      desc: t(
        "Native Arabic support with proper right-to-left layout. Built from the ground up for Arabic speakers.",
        "دعم عربي أصلي مع تنسيق من اليمين لليسار. مبني من الأساس للعرب.",
      ),
      color: "hsl(145,70%,42%)",
    },
    {
      title: t("WhatsApp Button", "زر واتساب"),
      desc: t(
        "Let visitors message you directly with one tap. Perfect for businesses.",
        "خل الزوار يتواصلون معك مباشرة بضغطة واحدة. مثالي للشركات.",
      ),
      color: "hsl(145,70%,42%)",
    },
    {
      title: t("Custom Domain", "دومين مخصص"),
      desc: t(
        "Use your own domain for a professional, branded bio link.",
        "استخدم دومينك الخاص لرابط بايو احترافي بعلامتك التجارية.",
      ),
      color: "hsl(280,60%,55%)",
    },
  ];
  ...
  return (
    <section
      ...
      style={{
        background:
          "linear-gradient(180deg, hsl(35 40% 95%) 0%, hsl(35 30% 93%) 50%, hsl(35 40% 95%) 100%)",
      }}
    >
      {/* Animated orbs */}
      <GlowOrb
        className="w-96 h-96 top-10 end-[5%]"
        color1="hsl(var(--sky))"
        color2="transparent"
        delay={0}
      />
      <GlowOrb
        className="w-80 h-80 bottom-20 start-[8%]"
        color1="hsl(280,60%,55%)"
        color2="transparent"
        delay={3}
      />
      ...
      {/* Decorative shapes */}
      <FloatingShape
        className="absolute top-32 end-[15%] opacity-[0.06] pointer-events-none"
        delay={1}
        duration={25}
      >
      ...
      <FloatingShape
        className="absolute bottom-40 start-[12%] opacity-[0.05] pointer-events-none"
        delay={3}
        duration={22}
      >
      ...
      <FloatingShape
        className="absolute top-1/2 start-[3%] opacity-[0.04] pointer-events-none"
        delay={5}
        duration={30}
      >
      ...
      <div className="container mx-auto px-6 relative">
        ...
        >
          <motion.span
            ...
            viewport={{ once: true }}
            className="inline-flex items-center gap-1.5 px-5 py-2 rounded-full bg-gradient-to-r from-[hsl(var(--sky))]/15 to-[hsl(280,60%,55%)]/10 text-[hsl(var(--sky))] text-xs font-bold font-body mb-6 border border-[hsl(var(--sky))]/10"
          >
          ...
          <p className="font-body text-lg text-[hsl(var(--navy))]/45 max-w-lg mx-auto">
            {t(
              "No missing features. No paywalls. Everything included from day one.",
              "بدون ميزات ناقصة. بدون رسوم. كل شي من أول يوم.",
            )}
          </p>
        </motion.div>
            ...
            {featureItems.map((item, i) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="ps-4">
                    <h3
                      className={`font-display text-lg font-bold mb-1.5 transition-colors duration-300 ${isActive ? "text-[hsl(var(--navy))]" : "text-[hsl(var(--navy))]/60"}`}
                    >
                      {item.title}
                    </h3>
                    <motion.p
...
/* ═══════════════════════════════════════════════════════════════════
   ...
   ═══════════════════════════════════════════════════════════════════ */
const StepsAnimationSection = ({
  steps,
  t,
}: {
  steps: { num: string; emoji: string; title: string; desc: string }[];
  t: (en: string, ar: string) => string;
}) => {
  const { smartLink } = useSmartLink();
  const stepData = [
    {
      gradient: "from-[hsl(var(--sky))] to-[hsl(280,60%,55%)]",
      bgAccent: "bg-[hsl(var(--sky))]/6",
      iconBg: "hsl(var(--sky))",
    },
    {
      gradient: "from-[hsl(var(--navy))] to-[hsl(var(--sky))]",
      bgAccent: "bg-[hsl(var(--navy))]/5",
      iconBg: "hsl(var(--navy))",
    },
    {
      gradient: "from-[hsl(145,70%,42%)] to-[hsl(170,60%,45%)]",
      bgAccent: "bg-[hsl(145,70%,42%)]/5",
      iconBg: "hsl(145,70%,42%)",
    },
  ];
  ...
  return (
    <section className="section-cream py-24 md:py-32 relative overflow-hidden">
      <GlowOrb
        className="w-[500px] h-[500px] top-1/2 start-1/2 -translate-x-1/2 -translate-y-1/2"
        color1="hsl(var(--sky))"
        color2="transparent"
      />

      <FloatingShape
        className="absolute top-20 end-[10%] opacity-[0.04] pointer-events-none"
        delay={2}
      >
            ...
            return (
              ...
              >
                <div className="relative bg-white rounded-3xl overflow-hidden border border-[hsl(var(--navy))]/6 shadow-lg hover:shadow-2xl hover:-translate-y-2 transition-all duration-400">
                  ...
                  {/* Decorative bg */}
                  <div
                    className={`absolute top-8 end-4 w-24 h-24 ${sd.bgAccent} rounded-full blur-2xl pointer-events-none group-hover:scale-150 transition-transform duration-500`}
                  />
                  ...
                  <div className="p-8 pt-7 relative">
                    ...
                    >
                      <div
                        className={`w-14 h-14 rounded-2xl bg-gradient-to-br ${sd.gradient} flex items-center justify-center shadow-lg`}
                      >
                    ...
                    <h3 className="font-display font-bold text-xl text-[hsl(var(--navy))] mb-3">
                      {s.title}
                    </h3>
                    <p className="font-body text-sm text-[hsl(var(--navy))]/50 leading-relaxed">
                      {s.desc}
                    </p>
                  </div>
                </div>
  ...
  const useCases = [
    {
      ...
      desc: t(
        "One page for your portfolio, social links, and latest content.",
        "صفحة واحدة لمعرض أعمالك وروابط السوشال وآخر محتواك.",
      ),
      ...
      links: [
        {
          icon: Briefcase,
          label: t("View my portfolio", "شاهد أعمالي"),
          sub: t("18 projects", "18 مشروع"),
        },
        {
          icon: PlayCircle,
          label: t("Latest case study", "آخر دراسة حالة"),
          sub: t("New", "جديد"),
        },
        {
          icon: Youtube,
          label: t("Design tutorials", "دروس تصميم"),
          sub: "YouTube",
        },
        {
          icon: Instagram,
          label: t("Daily inspiration", "إلهام يومي"),
          sub: "@fatima.designs",
        },
      ],
    },
    {
      ...
      desc: t(
        "Share your location, menu, offers, and let customers reach you on WhatsApp.",
        "شارك موقعك وقائمتك وعروضك وخل العملاء يتواصلون معك عبر الواتساب.",
      ),
      ...
      links: [
        {
          icon: UtensilsCrossed,
          label: t("View our menu", "تصفح القائمة"),
          sub: t("Updated daily", "محدثة يومياً"),
        },
        {
          icon: CalendarCheck,
          label: t("Reserve a table", "احجز طاولة"),
          sub: t("Quick book", "حجز سريع"),
        },
        {
          icon: MessageCircle,
          label: t("WhatsApp order", "اطلب واتساب"),
          sub: t("Reply in 2 min", "رد خلال دقيقتين"),
        },
        {
          icon: MapPin,
          label: t("Find us", "الموقع"),
          sub: t("Al Olaya, Riyadh", "العليا، الرياض"),
        },
      ],
    },
    {
      ...
      desc: t(
        "One link for all platforms, brand deals, and affiliate links with full analytics.",
        "رابط واحد لكل منصاتك وصفقات البراندات وروابط الأفلييت مع تحليلات كاملة.",
      ),
      gradient: "from-[hsl(var(--navy))] to-[hsl(var(--sky))]",
      ...
      links: [
        {
          icon: Briefcase,
          label: t("Our services", "خدماتنا"),
          sub: t("Branding · Web · UX", "هوية · مواقع · تجربة"),
        },
        {
          icon: Eye,
          label: t("Featured work", "أعمال مختارة"),
          sub: t("12 case studies", "12 دراسة"),
        },
        {
          icon: MessageCircle,
          label: t("Start a project", "ابدأ مشروع"),
          sub: t("Free consultation", "استشارة مجانية"),
        },
        {
          icon: ShoppingBag,
          label: t("Shop templates", "متجر القوالب"),
          sub: t("From 49 SAR", "من 49 ريال"),
        },
      ],
    },
  ];
  ...
  const steps = [
    {
      num: "1",
      emoji: "🎨",
      title: t("Choose a theme", "اختر ثيم"),
      desc: t(
        "Pick from beautiful pre-made themes.",
        "اختر من ثيمات جاهزة وجميلة.",
      ),
    },
    {
      num: "2",
      emoji: "🧩",
      title: t("Add your content", "أضف محتواك"),
      desc: t(
        "Drag and drop blocks to build your page.",
        "اسحب وأفلت البلوكات لبناء صفحتك.",
      ),
    },
    {
      num: "3",
      emoji: "🚀",
      title: t("Share your link", "شارك رابطك"),
      desc: t(
        `Put ${brand.domain}/you in your bio and go.`,
        `حط ${brand.domain}/you في البايو وانطلق.`,
      ),
    },
  ];
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="section-cream pt-32 pb-20 md:pt-40 md:pb-28 relative overflow-hidden">
        ...
        <GlowOrb
          className="w-[500px] h-[500px] -top-20 end-[5%]"
          color1="hsl(var(--sky))"
          color2="transparent"
          delay={0}
        />
        <GlowOrb
          className="w-[400px] h-[400px] bottom-0 start-[3%]"
          color1="hsl(280,60%,55%)"
          color2="transparent"
          delay={2}
        />
        <GlowOrb
          className="w-72 h-72 top-1/3 start-[40%]"
          color1="hsl(350,60%,55%)"
          color2="transparent"
          delay={4}
        />
        ...
        <FloatingShape
          className="absolute top-40 end-[8%] opacity-[0.05] pointer-events-none"
          delay={0}
          duration={18}
        >
        ...
        <FloatingShape
          className="absolute bottom-20 start-[15%] opacity-[0.04] pointer-events-none"
          delay={2}
          duration={22}
        >
        ...
        <FloatingShape
          className="absolute top-60 start-[5%] opacity-[0.03] pointer-events-none"
          delay={4}
          duration={26}
        >
        ...
        <FloatingShape
          className="absolute bottom-40 end-[20%] opacity-[0.04] pointer-events-none"
          delay={6}
          duration={20}
        >
            ...
            >
              ...
              >
                <div className="flex-1 flex items-center bg-white rounded-s-full border border-e-0 border-[hsl(var(--navy))]/10 px-5 py-4 shadow-md">
                  <span className="text-sm font-body text-[hsl(var(--navy))]/30 shrink-0">
                    {brand.domain}/
                  </span>
                  <input
                    type="text"
              ...
              >
                {[
                  t("Free forever", "مجاني للأبد"),
                  t("Arabic support", "دعم العربية"),
                  t("No ads", "بدون إعلانات"),
                ].map((f, i) => (
                  <span
                    key={i}
                    className="flex items-center gap-1.5 text-xs font-body text-[hsl(var(--navy))]/45"
                  >
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <div>
                    <p className="font-display font-bold text-sm text-[hsl(var(--navy))] leading-none">
                      1,420
                    </p>
                    <p className="text-[10px] font-body text-[hsl(var(--navy))]/40">
                      {t("views today", "مشاهدة اليوم")}
                    </p>
                  </div>
                </motion.div>
      ...
      <section
        ...
        style={{
          background:
            "linear-gradient(180deg, hsl(35 40% 95%) 0%, hsl(35 35% 94%) 100%)",
        }}
      >
        <GlowOrb
          className="w-[600px] h-[300px] top-0 start-1/2 -translate-x-1/2"
          color1="hsl(var(--sky))"
          color2="transparent"
          delay={1}
        />
        ...
        <FloatingShape
          className="absolute top-20 start-[8%] opacity-[0.04] pointer-events-none"
          delay={1}
          duration={24}
        >
        ...
        <div className="container mx-auto px-6 relative">
          ...
          >
            ...
            <p className="font-body text-lg text-[hsl(var(--navy))]/45 max-w-md mx-auto">
              {t(
                "From creators to restaurants, one bio page fits all.",
                "من المبدعين للمطاعم، صفحة بايو واحدة تناسب الجميع.",
              )}
            </p>
          </motion.div>
          ...
          <div className="space-y-6 max-w-4xl mx-auto">
            {useCases.map((uc, i) => (
              ...
              >
                ...
                {/* Gradient overlay */}
                <div
                  className={`absolute inset-0 bg-gradient-to-br ${uc.gradient} opacity-80 pointer-events-none`}
                />
                ...
                <div className="relative flex flex-col md:flex-row md:items-center gap-8">
                  <div className="flex-1">
                    <motion.h3 className="font-display font-bold text-white text-2xl md:text-3xl mb-3">
                      {uc.title}
                    </motion.h3>
                    <p className="font-body text-white/75 text-base leading-relaxed max-w-sm mb-5">
                      {uc.desc}
                    </p>
                    <Link to={smartLink("/signup", "/dashboard/bio-pages")}>
                      <Button
                        variant="ghost"
                        className="text-white/90 hover:text-white hover:bg-white/15 font-body font-bold text-sm px-5 py-2.5 h-auto gap-2 rounded-full border border-white/20 backdrop-blur-sm"
                      >
                  ...
                  >
                    <div className="rounded-[2rem] p-[3px] bg-gradient-to-b from-white/40 to-white/10 shadow-2xl">
                      <div
                        className="rounded-[1.85rem] overflow-hidden relative"
                        style={{ background: uc.theme.bg, color: uc.theme.fg }}
                      >
                        {/* Status bar */}
                        ...
                        <div className="px-4 pb-4">
                          ...
                          <div className="flex justify-center mb-3">
                            <span
                              ...
                              style={{
                                background: uc.theme.btnBg,
                                border: `1px solid ${uc.theme.btnBorder}`,
                              }}
                            >
                              {uc.handle}
                            </span>
                          ...
                          <div className="flex flex-col items-center mb-3">
                            {(uc as any).avatarImage ? (
                              <img
                                src={(uc as any).avatarImage}
                                alt={uc.profileName}
                                className="w-12 h-12 rounded-full object-cover mb-1.5 ring-2"
                                style={{
                                  boxShadow: `0 0 0 2px ${uc.theme.accent}`,
                                }}
                              />
                            ) : (
                              <div
                                className="w-12 h-12 rounded-full mb-1.5 flex items-center justify-center text-[11px] font-bold"
                                style={{
                                  background: uc.theme.accent,
                                  color: uc.theme.bg.includes("ffffff")
                                    ? "#0f1b3d"
                                    : "#1a0f1f",
                                }}
                              >
                            ...
                            <div className="flex items-center gap-1">
                              <span className="text-[11px] font-display font-bold leading-tight">
                                {uc.profileName}
                              </span>
                              {uc.verified && (
                                <BadgeCheck
                                  className="w-3 h-3"
                                  style={{ color: uc.theme.accent }}
                                  fill={uc.theme.accent}
                                  stroke={
                                    uc.theme.bg.includes("ffffff")
                                      ? "#fff"
                                      : "#1a0f1f"
                                  }
                                  strokeWidth={2.5}
                            ...
                            <span className="text-[8.5px] mt-0.5 opacity-70">
                              {uc.profileBio}
                            </span>

                            {/* Stat chip */}
                            <div
                              className="mt-2 flex items-center gap-1 px-2 py-0.5 rounded-full text-[8px] font-bold"
                              style={{
                                background: uc.theme.btnBg,
                                border: `1px solid ${uc.theme.btnBorder}`,
                              }}
                              ...
                              return (
                                <motion.div
                                  ...
                                  style={{
                                    background: uc.theme.btnBg,
                                    border: `1px solid ${uc.theme.btnBorder}`,
                                    color: uc.theme.btnFg,
                                  }}
                                >
                                  <div
                                    className="w-6 h-6 rounded-md flex items-center justify-center shrink-0"
                                    style={{
                                      background: uc.theme.accent + "33",
                                    }}
                                  >
                                    <Icon
                                      className="w-3 h-3"
                                  ...
                                  <div className="flex-1 min-w-0">
                                    <p className="text-[9.5px] font-bold leading-tight truncate">
                                      {link.label}
                                    </p>
                                    {link.sub && (
                                      <p className="text-[7.5px] opacity-60 leading-tight truncate mt-0.5">
                                        {link.sub}
                                      </p>
                                    )}
                                  </div>
                          ...
                          <div
                            ...
                            style={{ background: uc.theme.btnBorder }}
                          />
                        </div>
                      </div>
                    </div>
      ...
      {/* ═══ FEATURES ═══ */}
      <ThemeShowcaseSection features={features} t={t} brand={brand} />
