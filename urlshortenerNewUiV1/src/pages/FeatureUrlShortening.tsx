  ...
  const benefits = [
    {
      ...
      desc: t(
        "Paste any URL and get a short link in under a second. No signup required to try.",
        "الصق أي رابط واحصل على رابط قصير في أقل من ثانية. بدون تسجيل للتجربة.",
      ),
      num: "01",
    },
    {
      ...
      desc: t(
        "Track every click with detailed analytics: location, device, browser, and referral source.",
        "تتبع كل نقرة بتحليلات مفصلة: الموقع، الجهاز، المتصفح، ومصدر الإحالة.",
      ),
      num: "02",
    },
    {
      ...
      desc: t(
        "Your data stays in Saudi Arabia. Fully compliant with local regulations and PDPL.",
        "بياناتك تبقى في السعودية. متوافق تماماً مع الأنظمة المحلية ونظام حماية البيانات.",
      ),
      num: "03",
    },
    {
  ...
  const useCases = [
    {
      ...
      desc: t(
        "Track which ads, posts, and emails drive the most clicks with UTM-tagged short links.",
        "تتبع أي الإعلانات والمنشورات والإيميلات تجلب أكثر ضغطات مع روابط UTM قصيرة.",
      ),
      stat: "3.2x",
    ...
    },
    {
      ...
      desc: t(
        "One clean link in your bio instead of a long messy URL. Change the destination anytime.",
        "رابط واحد نظيف في البايو بدلاً من رابط طويل فوضوي. غيّر الوجهة في أي وقت.",
      ),
      stat: "47%",
    ...
    },
    {
      ...
      desc: t(
        "Short links save characters in SMS and look professional in WhatsApp messages.",
        "الروابط القصيرة توفر حروف في الرسائل وتبان احترافية في رسائل الواتساب.",
      ),
      stat: "60%",
            ...
            >
              ...
              <h1 className="font-display text-4xl md:text-5xl lg:text-6xl font-bold mb-6 tracking-tight leading-[1.1] text-[hsl(var(--navy))]">
                ...
                <span className="text-[hsl(var(--sky))]">
                  {t("Track everything.", "تتبع كل شيء.")}
                </span>
              </h1>
              ...
              <div className="bg-white rounded-2xl border border-[hsl(var(--navy))]/8 p-5 shadow-card max-w-lg">
                ...
                {urlError && (
                  <p className="mt-2 text-xs font-body text-red-500 ps-1">
                    {urlError}
                  </p>
                )}
                ...
                {shortenedUrl && (
                  ...
                  >
                    <div>
                      <span className="text-[10px] font-body text-[hsl(var(--sky))] block mb-0.5">
        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {stats.map((stat, i) => (
              ...
              >
                <p className="font-display text-2xl md:text-3xl font-bold text-[hsl(var(--sky))] mb-1">
                  {stat.value}
                </p>
        ...
        <div className="container mx-auto px-6 relative">
          ...
          >
            ...
            <p className="font-body text-lg text-[hsl(var(--navy))]/50 max-w-lg mx-auto">
              {t(
                "Simple tools that just work, built for the Saudi market.",
                "أدوات بسيطة تشتغل، مبنية للسوق السعودي.",
              )}
            </p>
          </motion.div>
          ...
          <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            >
              <div className="flex items-center gap-3 mb-2">
                ...
                <h3 className="font-display font-bold text-sm text-[hsl(var(--navy))]">
                  {t("Instant shortening", "اختصار فوري")}
                </h3>
              </div>
              <p className="font-body text-xs text-[hsl(var(--navy))]/40 leading-relaxed mb-auto">
                {t(
                  "Paste any URL and get a short link in under a second.",
                  "الصق أي رابط واحصل على رابط قصير في أقل من ثانية.",
                )}
              </p>
            ...
            >
              <div className="flex items-center gap-3 mb-2">
                ...
                <h3 className="font-display font-bold text-sm text-[hsl(var(--navy))]">
                  {t("Saudi hosted", "استضافة سعودية")}
                </h3>
              </div>
              <p className="font-body text-xs text-[hsl(var(--navy))]/40 leading-relaxed">
                {t(
                  "Your data stays in Saudi Arabia. Fully compliant.",
                  "بياناتك تبقى في السعودية. متوافق تماماً.",
                )}
              </p>
            ...
            >
              <div className="flex items-center gap-3 mb-2">
                ...
                <h3 className="font-display font-bold text-sm text-[hsl(var(--navy))]">
                  {t("Custom domains", "نطاقات مخصصة")}
                </h3>
              </div>
              <p className="font-body text-xs text-[hsl(var(--navy))]/40 leading-relaxed">
                {t(
                  "Use your own brand domain. Free SSL included.",
                  "استخدم نطاق علامتك. SSL مجاني.",
                )}
              </p>
              <div className="mt-auto pt-4">
                <div className="bg-[hsl(var(--navy))]/[0.03] rounded-lg px-3 py-2 flex items-center gap-2">
                  ...
                  <span className="font-mono text-[11px] text-[hsl(var(--navy))]/50">
                    go.yourshop.sa/offer
                  </span>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="flex items-center gap-3 mb-2">
                ...
                <h3 className="font-display font-bold text-sm text-[hsl(var(--navy))]">
                  {t("Custom aliases", "أسماء مخصصة")}
                </h3>
              </div>
              <p className="font-body text-xs text-[hsl(var(--navy))]/40 leading-relaxed">
                {t(
                  "Choose memorable link names instead of random codes.",
                  "اختر أسماء روابط سهلة الحفظ بدلاً من أكواد عشوائية.",
                )}
              </p>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="space-y-4 max-w-3xl mx-auto">
            {useCases.map((uc, i) => (
              ...
              >
                <div
                  className={`absolute inset-0 bg-gradient-to-r ${uc.gradient} pointer-events-none`}
                />
                <div className="relative flex flex-col md:flex-row items-start md:items-center gap-5 p-6 md:p-7">
                  ...
                  <div className="flex-1 min-w-0">
                    <h3 className="font-display font-bold text-[hsl(var(--navy))] mb-1.5 text-lg">
                      {uc.title}
                    </h3>
                  ...
                  <div className="shrink-0 text-end md:text-center px-4 py-3 rounded-xl bg-[hsl(var(--navy))]/3">
                    <p className="font-display text-2xl font-bold text-[hsl(var(--sky))]">
                      {uc.stat}
                    </p>
                    <p className="font-body text-[10px] text-[hsl(var(--navy))]/40 whitespace-nowrap">
                      {uc.statLabel}
                    </p>
                  </div>
                </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center max-w-5xl mx-auto">
            ...
            >
              ...
              <h2 className="font-display text-3xl md:text-4xl font-bold tracking-tight text-[hsl(var(--navy))] mb-6">
                {t(
                  "The only URL shortener built for Saudi Arabia",
                  "مختصر الروابط الوحيد المبني للسعودية",
                )}
              </h2>
            ...
            >
              {comparisonItems.map((item, i) => (
                ...
                >
                  ...
                  <span className="font-body text-sm text-[hsl(var(--navy))]">
                    {item}
                  </span>
                </motion.div>
              ))}
            ...
            >
              ...
              <div className="flex flex-wrap gap-2">
                {["utm_source", "utm_medium", "utm_campaign"].map((tag) => (
                  <span
                    key={tag}
                    className="px-3 py-1.5 rounded-full bg-[hsl(var(--navy))]/5 text-[hsl(var(--navy))]/60 text-xs font-mono font-bold"
                  >
                    {tag}
                  </span>
                ))}
