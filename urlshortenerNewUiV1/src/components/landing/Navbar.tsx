        ...
        <div className="bg-white rounded-full px-6 py-2 flex items-center justify-between shadow-card">
          ...
          <div className="hidden md:flex items-center gap-1">
            {[
              ...
              { href: "#analytics", label: t("Analytics", "التحليلات") },
              { href: "#developers", label: t("Developers", "المطورين") },
            ].map((link) => (
              <a
                key={link.href}
                href={link.href}
      ...
      {isOpen && (
        <div className="md:hidden mx-4 mt-2 bg-white rounded-3xl shadow-card px-5 pb-4">
          <div className="flex flex-col gap-1 pt-3 font-body text-sm">
            <a href="#features" className="text-[hsl(var(--navy))]/70 hover:text-[hsl(var(--navy))] py-2.5 px-3 rounded-xl">{t("Features", "الميزات")}</a>
            <a href="#analytics" className="text-[hsl(var(--navy))]/70 hover:text-[hsl(var(--navy))] py-2.5 px-3 rounded-xl">{t("Analytics", "التحليلات")}</a>
            <a href="#developers" className="text-[hsl(var(--navy))]/70 hover:text-[hsl(var(--navy))] py-2.5 px-3 rounded-xl">{t("Developers", "المطورين")}</a>
