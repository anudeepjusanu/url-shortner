      ...
      ? [
          {
            ...
            items: [
              ...
              {
                label: t("sidebar.urlManagement") || "URL Management",
                path: "/admin-urls",
                icon: (
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
  ...
  const headerItems = (
    <>
      ...
      <div className="create-link-user-profile">
        ...
        <span className="create-link-user-name">{displayName}</span>
      </div>
      ...
      <div className="create-link-header-content">
        ...
        <div className="create-link-header-right">
          ...
          <div className="create-link-user-profile-wrapper" ref={dropdownRef}>
            <div
              className="create-link-user-profile"
