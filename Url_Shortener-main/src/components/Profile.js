...
const Profile = () => {
  ...
  const loadData = async () => {
    try {
      const [profileRes, statsRes, domainsRes, keyRes, prefsRes] =
      ...
      if (statsRes.status === "fulfilled") {
        setStats((prev) => ({
          ...prev,
          ...statsRes.value,
          totalLinks: statsRes.value.totalLinks || 0,
        }));
      }
  ...
  const updateProfile = async (e) => {
    ...
    try {
      ...
      setToast({
        type: "error",
        message: err.message || t("profile.messages.failedToUpdate"),
      });
    } finally {
      setLoading(false);
    }
  ...
  const updatePassword = async (e) => {
    ...
    if (security.newPassword !== security.confirmPassword) {
      setToast({
        type: "error",
        message: t("profile.messages.passwordsDoNotMatch"),
      });
      return;
    }
    setLoading(true);
    try {
      ...
      setToast({
        type: "success",
        message: t("profile.messages.passwordUpdated"),
      });
      setSecurity({
        currentPassword: "",
        newPassword: "",
      ...
      setToast({
        type: "error",
        message: err.message || t("profile.messages.failedToUpdatePassword"),
      });
    } finally {
      setLoading(false);
    }
  ...
  const regenerateKey = async () => {
    ...
    try {
      ...
      if (res.apiKey) {
        ...
        setToast({
          type: "success",
          message: t("profile.messages.apiKeyRegenerated"),
        });
      }
    } catch (err) {
      setToast({
        type: "error",
        message: t("profile.messages.failedToRegenerateKey"),
      });
    }
  };
  ...
  const updatePreferences = async (e) => {
    ...
    try {
      ...
      setToast({
        type: "success",
        message: t("profile.messages.preferencesUpdated"),
      });
    } catch (err) {
      setToast({
        type: "error",
        message: t("profile.messages.failedToUpdatePreferences"),
      });
    }
  };
                  ...
                  <div className="flex gap-2">
                    ...
                    <Button
                      ...
                      onClick={() => {
                        ...
                        setToast({
                          type: "success",
                          message: t("myLinks.copiedToClipboard"),
                        });
                      }}
                    >
