...
const Navbar = () => {
  ...
  const adminItems = [
    ...
    // {
    //   label: t("sidebar.googleAnalytics") || "Google Analytics",
        ...
        <div className="md:hidden border-t p-4 bg-background absolute w-full shadow-lg">
          <nav className="flex flex-col space-y-2">
            ...
            {hasRole(["admin", "super_admin"]) && (
              <>
                <div className="px-3 text-xs font-semibold text-muted-foreground mt-4 mb-1 uppercase tracking-wider">
                  Admin
                </div>
                {adminItems
                  .filter((i) => hasRole(i.role))
